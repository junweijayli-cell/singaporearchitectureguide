(function () {
  ...
  const defaultPlanLabel =
    project.assets.planType === "footprint" ? "Whole-building plan diagram" : "Typical floor plan";
  const defaultPlanDescription =
    project.assets.planType === "footprint"
      ? "A whole-project plan diagram focusing on the overall building footprint and open voids where a published typical floor plan was not publicly accessible."
